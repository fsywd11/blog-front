  ...
  <el-row class="login-page">
    <el-col class="form">
      ...
      <el-form ref="form" size="large" autocomplete="off" v-else :model="registerData" :rules="rules">
        ...
        <!-- 登录按钮 -->
        <el-form-item>
          <el-button class="button" type="success" auto-insert-space @click="login">立即登录</el-button>
        </el-form-item>
        <!--注册按钮-->
        <el-divider>没有账号</el-divider>
        <el-form-item>
          <el-button class="button" type="danger" auto-insert-space @click="isRegister = true;clearRegisterData()">
            立即注册
          </el-button>
        </el-form-item>
