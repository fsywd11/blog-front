  ...
  "node_modules/tinymce/plugins/media/plugin.js"() {
    (function() {
      ...
      const submitForm = (prevData, newData, editor) => {
        newData.embed = shouldInsertAsNewIframe(prevData, newData) && hasDimensions(editor) ? dataToHtml(editor, { ...newData, embed: "" }) : updateHtml(newData.embed ?? "", newData, false, editor.schema);
