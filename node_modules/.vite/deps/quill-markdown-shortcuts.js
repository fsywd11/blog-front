import {
  require_quill
} from "./chunk-EH4H6VB6.js";
import {
  __commonJS
} from "./chunk-2TUXWMP5.js";

// node_modules/quill-markdown-shortcuts/dist/markdownShortcuts.js
var require_markdownShortcuts = __commonJS({
  "node_modules/quill-markdown-shortcuts/dist/markdownShortcuts.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
        module.exports = factory(require_quill());
      else if (typeof define === "function" && define.amd)
        define(["quill"], factory);
      else if (typeof exports === "object")
        exports["MarkdownShortcuts"] = factory(require_quill());
      else
        root["MarkdownShortcuts"] = factory(root["quill"]);
    })(typeof self !== "undefined" ? self : exports, function(__WEBPACK_EXTERNAL_MODULE_0__) {
      return (
        /******/
        function(modules) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var MarkdownShortcuts = function() {
              function MarkdownShortcuts2(quill, options) {
                var _this = this;
                _classCallCheck(this, MarkdownShortcuts2);
                this.quill = quill;
              ...
              _createClass(MarkdownShortcuts2, [{
                key: "isValid",
                ...
                value: function onSpace() {
                  ...
                  if (!selection) return;
                  var _quill$getLine = this.quill.getLine(selection.index), _quill$getLine2 = _slicedToArray(_quill$getLine, 2), line = _quill$getLine2[0], offset = _quill$getLine2[1];
                ...
                value: function onEnter() {
                  var selection = this.quill.getSelection();
                  if (!selection) return;
                  var _quill$getLine3 = this.quill.getLine(selection.index), _quill$getLine4 = _slicedToArray(_quill$getLine3, 2), line = _quill$getLine4[0], offset = _quill$getLine4[1];
                  var text = line.domNode.textContent + " ";
                  var lineStart = selection.index - offset;
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var HorizontalRule = function(_BlockEmbed) {
              _inherits(HorizontalRule2, _BlockEmbed);
              function HorizontalRule2() {
                _classCallCheck(this, HorizontalRule2);
                return _possibleConstructorReturn(this, (HorizontalRule2.__proto__ || Object.getPrototypeOf(HorizontalRule2)).apply(this, arguments));
              }
              return HorizontalRule2;
            }(BlockEmbed);
            HorizontalRule.blotName = "hr";
            HorizontalRule.tagName = "hr";
            exports2.default = HorizontalRule;
          }
          /******/
        ])
      );
...
export default require_markdownShortcuts();
//# sourceMappingURL=quill-markdown-shortcuts.js.map
